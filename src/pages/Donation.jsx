...
const Donation = () => {
  ...
  return (
    ...
    <div class="screen">
        ...
        <div className='login-text'><center>Donation</center></div>
            <form class="login">
                <div class="login__field">
                    <input type="number" class="login__input" placeholder="Donation_ID"></input>
                </div>
                <div class="login__field">
                ...
                <div class="login__field">
                    <input type="number" class="login__input" placeholder="Amount"></input>
                </div>
                <div class="login__field">
                    <input type="number" class="login__input" placeholder="PAN_No"></input>
                </div>
